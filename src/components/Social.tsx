...
export const Social: React.FC = () => {
  ...
  return (
    <section className="py-2" id="social">
      <div className="container-custom">
        <h2 className="text-lg font-bold mb-2 flex items-center">
          <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">Connect With Me</span>
          <Badge variant="outline" className="ml-2 text-xs bg-blue-50 text-blue-600 border-blue-100">@jiteshy</Badge>
        </h2>
          ...
          <TooltipProvider>
            <Tooltip>
              <TooltipTrigger asChild>
                ...
                >
                  <Card className="card-hover transition-all duration-200 hover:border-blue-300 hover:shadow-md hover:shadow-blue-100 cursor-pointer">
                    <CardContent className="p-3 flex items-center gap-2">
                      <div className="p-1.5 rounded-full bg-gradient-to-br from-blue-500 to-blue-600">
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <a 
                  ...
                  className="no-underline"
                >
                  <Card className="card-hover transition-all duration-200 hover:border-gray-500 hover:shadow-md hover:shadow-gray-100 cursor-pointer">
                    <CardContent className="p-3 flex items-center gap-2">
                      <div className="p-1.5 rounded-full bg-gradient-to-br from-gray-700 to-gray-900">
              ...
              <TooltipContent>
                <p className="text-xs">See my GitHub repositories</p>
              </TooltipContent>
            </Tooltip>
          </TooltipProvider>
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <a 
                  ...
                  className="no-underline"
                >
                  <Card className="card-hover transition-all duration-200 hover:border-green-300 hover:shadow-md hover:shadow-green-100 cursor-pointer">
                    <CardContent className="p-3 flex items-center gap-2">
                      <div className="p-1.5 rounded-full bg-gradient-to-br from-green-500 to-green-600">
              ...
              <TooltipContent>
                <p className="text-xs">Read my articles on Medium</p>
              </TooltipContent>
            </Tooltip>
          </TooltipProvider>
        </div>
