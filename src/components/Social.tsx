  ...
  return (
    <section className="py-2" id="social">
      <div className="container-custom">
        <h2 className="text-lg font-bold mb-1">Connect With Me</h2>
        ...
        <div className="grid grid-cols-3 gap-2">
          <Card className="card-hover">
            <CardContent className="p-2 flex flex-col items-center">
              ...
              <h3 className="text-xs font-medium mt-1">LinkedIn</h3>
              <Button asChild variant="outline" size="sm" className="mt-1 text-xs py-0 h-5 w-full">
                <a 
          ...
          <Card className="card-hover">
            <CardContent className="p-2 flex flex-col items-center">
              ...
              <h3 className="text-xs font-medium mt-1">GitHub</h3>
              <Button asChild variant="outline" size="sm" className="mt-1 text-xs py-0 h-5 w-full">
                <a 
          ...
          <Card className="card-hover">
            <CardContent className="p-2 flex flex-col items-center">
              ...
              <h3 className="text-xs font-medium mt-1">Medium</h3>
              <Button asChild variant="outline" size="sm" className="mt-1 text-xs py-0 h-5 w-full">
                <a 
