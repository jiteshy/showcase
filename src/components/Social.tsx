        ...
        <div className="grid grid-cols-3 gap-2">
          <Card className="card-hover">
            <CardContent className="p-2 flex flex-col items-center">
              <div className="mb-1 p-1 bg-blue-100 rounded-full">
                <Linkedin className="h-4 w-4 text-blue-600" />
              </div>
              <h3 className="text-sm font-medium">LinkedIn</h3>
              <Button asChild variant="outline" size="sm" className="mt-1 text-xs py-0 h-6">
                <a 
          ...
          <Card className="card-hover">
            <CardContent className="p-2 flex flex-col items-center">
              <div className="mb-1 p-1 bg-gray-100 rounded-full">
          ...
          <Card className="card-hover">
            <CardContent className="p-2 flex flex-col items-center">
              <div className="mb-1 p-1 bg-green-100 rounded-full">
